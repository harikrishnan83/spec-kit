...
def init(
    ...
    enhancement_lines = [
        ...
        f"○ [cyan]/speckit.cross-feature[/] [bright_black](optional)[/bright_black] - Systems thinking alignment analysis to identify cross-feature conflicts (run after [cyan]/speckit.specify[/])",
